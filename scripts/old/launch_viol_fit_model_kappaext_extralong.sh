...
#SBATCH --job-name="violmedextralong"                     ## use the task id in the name of the job
...
Rscript /projects/b1108/projects/violence_mediation/scripts/viol_fit_model_kappaext_extralong.R

# sbatch -o /projects/b1108/projects/violence_mediation/viol_fit_kappaext_extralong.txt /projects/b1108/projects/violence_mediation/scripts/launch_viol_fit_model_kappaext_extralong.sh
