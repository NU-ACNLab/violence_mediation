...
#SBATCH --job-name="violmedscaledlongregress"             ## use the task id in the name of the job
...
Rscript /projects/b1108/projects/violence_mediation/scripts/viol_fit_model_scaled_long_regress.R

# sbatch -o /projects/b1108/projects/violence_mediation/viol_fit_scaled_long_regress.txt /projects/b1108/projects/violence_mediation/scripts/launch_viol_fit_model_scaled_long_regress.sh
