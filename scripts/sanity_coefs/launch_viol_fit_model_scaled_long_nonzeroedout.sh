...
#SBATCH --job-name="violmedscaledlongnonzeroedout"        ## use the task id in the name of the job
...
Rscript /projects/b1108/projects/violence_mediation/scripts/viol_fit_model_scaled_long_nonzeroedout.R

# sbatch -o /projects/b1108/projects/violence_mediation/launch/viol_fit_scaled_long_fulldata_nonzeroedout.txt /projects/b1108/projects/violence_mediation/scripts/launch_viol_fit_model_scaled_long_nonzeroedout.sh
