...
M2 <- as.matrix(final_df[, paste0('region', c(13:44, 252, 253, 272, 273, 295, 296, 299, 300))])
...
saveRDS(re, '/projects/b1108/projects/violence_mediation/models/within_networks/viol_re_somatomotordorsal.rds')

write.csv(re[[1]][[1]]$IE.M1M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1M2_somatomotordorsal.csv')
write.csv(re[[1]][[1]]$IE.M1, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1_somatomotordorsal.csv')
write.csv(re[[1]][[1]]$IE.M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M2_somatomotordorsal.csv')
