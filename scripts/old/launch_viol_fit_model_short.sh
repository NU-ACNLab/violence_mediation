...
Rscript /projects/b1108/projects/violence_mediation/scripts/viol_fit_model_short.R

# sbatch -o /projects/b1108/projects/violence_mediation/viol_fit_short.txt /projects/b1108/projects/violence_mediation/scripts/launch_viol_fit_model_short.sh
