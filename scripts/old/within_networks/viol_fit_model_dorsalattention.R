...
M2 <- as.matrix(final_df[, paste0('region', c(220:233, 275, 276))])
...
saveRDS(re, '/projects/b1108/projects/violence_mediation/models/within_networks/viol_re_dorsalattention.rds')

write.csv(re[[1]][[1]]$IE.M1M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1M2_dorsalattention.csv')
write.csv(re[[1]][[1]]$IE.M1, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1_dorsalattention.csv')
write.csv(re[[1]][[1]]$IE.M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M2_dorsalattention.csv')
