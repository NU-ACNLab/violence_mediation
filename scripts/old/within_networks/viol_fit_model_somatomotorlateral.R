...
M2 <- as.matrix(final_df[, paste0('region', c(45:49, 254, 255, 270, 271, 297, 298))])
...
saveRDS(re, '/projects/b1108/projects/violence_mediation/models/within_networks/viol_re_somatomotorlateral.rds')

write.csv(re[[1]][[1]]$IE.M1M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1M2_somatomotorlateral.csv')
write.csv(re[[1]][[1]]$IE.M1, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1_somatomotorlateral.csv')
write.csv(re[[1]][[1]]$IE.M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M2_somatomotorlateral.csv')
