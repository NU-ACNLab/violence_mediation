...
re_long <- readRDS('/projects/b1108/projects/violence_mediation/models/viol_re_scaled_long_regress.rds')
#re_long <- readRDS('/Users/flutist4129/Documents/Northwestern/projects/violence_mediation/models/viol_re_scaled_long_regress.rds')
...
write.csv(full_df, '/projects/b1108/projects/violence_mediation/models/viol_re_scaled_long_regress_summary.csv', row.names=FALSE)
...
for (m in 1:length(kappa1)) {
  ...
  #pdf(paste0('/Users/flutist4129/Documents/Northwestern/projects/violence_mediation/plots/kappa', m, '_regress_coefficients.pdf'), width=6, height=6)
  pdf(paste0('/projects/b1108/projects/violence_mediation/plots/kappa', m, '_regress_coefficients.pdf'), width=6, height=6)
  coeff_plot
  dev.off()
  ...
  pdf(paste0('/projects/b1108/projects/violence_mediation/plots/kappa', m, '_regress_coefficients_zero.pdf'), width=10, height=10)
  #pdf(paste0('/Users/flutist4129/Documents/Northwestern/projects/violence_mediation/plots/kappa', m, '_regress_coefficients_zero.pdf'), width=10, height=10)
...
bic_df[bic_df$bic %in%  min(bic_df$bic, na.rm=TRUE),] # still 4
...
re_long[[p]][[m]]$IE.M2[re_long[[p]][[m]]$IE.M2 != 0] #M2.32, M2.35, M2.143, M2.164
