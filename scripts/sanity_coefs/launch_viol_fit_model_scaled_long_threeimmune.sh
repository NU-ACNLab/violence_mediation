...
#SBATCH --job-name="violmedscaledlongthreeimmune"         ## use the task id in the name of the job
...
Rscript /projects/b1108/projects/violence_mediation/scripts/sanity_coefs/viol_fit_model_scaled_long_threeimmune.R

# sbatch -o /projects/b1108/projects/violence_mediation/launch/viol_fit_scaled_long_fulldata_threeimmune.txt /projects/b1108/projects/violence_mediation/scripts/sanity_coefs/launch_viol_fit_model_scaled_long_threeimmune.sh
