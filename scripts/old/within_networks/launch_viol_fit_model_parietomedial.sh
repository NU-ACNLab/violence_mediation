...
#SBATCH --job-name="parietomedial"                        ## use the task id in the name of the job
...
Rscript /projects/b1108/projects/violence_mediation/scripts/within_networks/viol_fit_model_parietomedial.R

# sbatch -o /projects/b1108/projects/violence_mediation/launch/viol_fit_parietomedial.txt /projects/b1108/projects/violence_mediation/scripts/within_networks/launch_viol_fit_model_parietomedial.sh
