...
M2 <- as.matrix(final_df[, paste0('region', c(141:174, 264, 265, 283))])
...
saveRDS(re, '/projects/b1108/projects/violence_mediation/models/within_networks/viol_re_visual.rds')

write.csv(re[[1]][[1]]$IE.M1M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1M2_visual.csv')
write.csv(re[[1]][[1]]$IE.M1, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1_visual.csv')
write.csv(re[[1]][[1]]$IE.M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M2_visual.csv')
