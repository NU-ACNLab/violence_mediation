...
M2 <- as.matrix(final_df[, paste0('region', 136:140)])
...
saveRDS(re, '/projects/b1108/projects/violence_mediation/models/within_networks/viol_re_parietomedial.rds')

write.csv(re[[1]][[1]]$IE.M1M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1M2_parietomedial.csv')
write.csv(re[[1]][[1]]$IE.M1, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1_parietomedial.csv')
write.csv(re[[1]][[1]]$IE.M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M2_parietomedial.csv')
