...
M2 <- as.matrix(final_df[, paste0('region', 1:12)])
...
saveRDS(re, '/projects/b1108/projects/violence_mediation/models/within_networks/viol_re_unassigned.rds')

write.csv(re[[1]][[1]]$IE.M1M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1M2_unassigned.csv')
write.csv(re[[1]][[1]]$IE.M1, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1_unassigned.csv')
write.csv(re[[1]][[1]]$IE.M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M2_unassigned.csv')
