...
#SBATCH --job-name="ventralattention"                     ## use the task id in the name of the job
...
Rscript /projects/b1108/projects/violence_mediation/scripts/within_networks/viol_fit_model_ventralattention.R

# sbatch -o /projects/b1108/projects/violence_mediation/launch/viol_fit_ventralattention.txt /projects/b1108/projects/violence_mediation/scripts/within_networks/launch_viol_fit_model_ventralattention.sh
