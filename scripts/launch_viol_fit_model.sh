...
Rscript /projects/b1108/projects/violence_mediation/scripts/viol_fit_model.R

# sbatch -o /projects/b1108/projects/violence_mediation/viol_fit.txt /projects/b1108/projects/violence_mediation/scripts/launch_viol_fit_model.sh
