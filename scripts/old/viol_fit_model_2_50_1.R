...
M1 <- as.matrix(final_df[, c('IL10', 'IL6')])
M2 <- as.matrix(final_df[, paste0('region', 1:50)])
...
saveRDS(re, '/projects/b1108/projects/violence_mediation/models/viol_re_2_50_1.rds')

write.csv(re[[1]][[1]]$IE.M1M2, '/projects/b1108/projects/violence_mediation/models/IE_M1M2_2_50_1.csv')
write.csv(re[[1]][[1]]$IE.M1, '/projects/b1108/projects/violence_mediation/models/IE_M1_2_50_1.csv')
write.csv(re[[1]][[1]]$IE.M2, '/projects/b1108/projects/violence_mediation/models/IE_M2_2_50_1.csv')
