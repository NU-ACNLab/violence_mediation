...
#SBATCH --job-name="violmedscaledlong"                    ## use the task id in the name of the job
...
# sbatch -o /projects/b1108/projects/violence_mediation/viol_fit_scaled_long.txt /projects/b1108/projects/violence_mediation/scripts/launch_viol_fit_model_scaled_long.sh
