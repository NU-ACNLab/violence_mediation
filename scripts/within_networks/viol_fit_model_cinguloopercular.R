...
M2 <- as.matrix(final_df[, paste0('region', c(50:68, 258:261, 266:269, 274, 293, 294))])
...
saveRDS(re, '/projects/b1108/projects/violence_mediation/models/within_networks/viol_re_cinguloopercular.rds')

write.csv(re[[1]][[1]]$IE.M1M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1M2_cinguloopercular.csv')
write.csv(re[[1]][[1]]$IE.M1, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M1_cinguloopercular.csv')
write.csv(re[[1]][[1]]$IE.M2, '/projects/b1108/projects/violence_mediation/models/within_networks/IE_M2_cinguloopercular.csv')
