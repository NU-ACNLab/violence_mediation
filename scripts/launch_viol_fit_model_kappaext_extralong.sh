...
# sbatch -o /projects/b1108/projects/violence_mediation/viol_fit_extralong.txt /projects/b1108/projects/violence_mediation/scripts/launch_viol_fit_model_extralong.sh
