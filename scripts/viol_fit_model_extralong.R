...
nu1=nu2<-2
kappa1=kappa2=kappa3=kappa4<-10^c(seq(-5,-3,length.out=5),seq(-3,0,length.out=15)[-1],seq(0,2,length.out=10)[-1])
...
saveRDS(re, '/projects/b1108/projects/violence_mediation/models/viol_re_mono_extralong.rds')

write.csv(re[[1]][[1]]$IE.M1M2, '/projects/b1108/projects/violence_mediation/models/IE_M1M2_mono_extralong.csv')
write.csv(re[[1]][[1]]$IE.M1, '/projects/b1108/projects/violence_mediation/models/IE_M1_mono_extralong.csv')
write.csv(re[[1]][[1]]$IE.M2, '/projects/b1108/projects/violence_mediation/models/IE_M2_mono_extralong.csv')
